    ...
    <table class="table mt-4 mb-13">
      ...
      <tbody>
        ...
        :class="{'text-secondary': !item.is_paid}">
          ...
          <td>
            <button class="btn btn-outline-topic" @click="openModal(item)" type="button">編輯</button>
          </td>
        </tr>
      </tbody>
    </table>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-check mt-5">
              ...
              <label class="form-check-label" for="defaultCheck1">是否付款</label>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-topic" data-dismiss="modal">取消</button>
            <button type="button" class="btn btn-warning" @click="updateOrder">確認</button>
          </div>
        </div>
      </div>
    </div>
